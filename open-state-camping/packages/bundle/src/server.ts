...
export function serverInstructions(): string {
  ...
  return [
    ...
    "",
    "Photos: get_site_details returns a site's photo URLs. Show them to the citizen by",
    "embedding each in your reply as a markdown image — ![Site 130 photo 1](URL) — so",
    "they appear inline, and also describe in words what they show (how exposed, treed,",
    "level, or private the site looks) for citizens who can't easily see the image.",
    "",
